  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.556 4.112 1.528 5.837L.057 23.215a.75.75 0 00.921.921l5.378-1.471A11.943 11.943 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.9 0-3.7-.503-5.25-1.387l-.378-.217-3.92 1.072 1.072-3.92-.217-.378A10 10 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
      </svg>
    </a>
  );
}
