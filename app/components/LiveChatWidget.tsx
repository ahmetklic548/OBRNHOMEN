  ...
  const send = () => {
    ...
    setTimeout(() => {
      ...
      const botReply: Message = {
        id: Date.now() + 1,
        from: "bot",
        text: "Mesajınızı aldık! WhatsApp'tan hemen yanıtlayacağız.",
        waLink: `https://wa.me/905316893849?text=${encoded}`,
      };
                  ...
                  >
                    ...
                    {msg.waLink && (
                      <a
                        ...
                        className="flex items-center gap-2 mt-2 px-3 py-2 rounded-xl text-white text-xs font-medium"
                      ...
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.122.554 4.122 1.524 5.86L0 24l6.288-1.496A11.96 11.96 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.854 0-3.6-.5-5.1-1.373l-.366-.217-3.732.888.916-3.638-.239-.376A9.96 9.96 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                        </svg>
